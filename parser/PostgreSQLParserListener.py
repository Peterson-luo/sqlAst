...
class PostgreSQLParserListener(ParseTreeListener):
    ...
    def enterSimple_select(self, ctx:PostgreSQLParser.Simple_selectContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#simple_select.
    def exitSimple_select(self, ctx:PostgreSQLParser.Simple_selectContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#union.
    def enterUnion(self, ctx:PostgreSQLParser.UnionContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#union.
    def exitUnion(self, ctx:PostgreSQLParser.UnionContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#intersect.
    def enterIntersect(self, ctx:PostgreSQLParser.IntersectContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#intersect.
    def exitIntersect(self, ctx:PostgreSQLParser.IntersectContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#except.
    def enterExcept(self, ctx:PostgreSQLParser.ExceptContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#except.
    def exitExcept(self, ctx:PostgreSQLParser.ExceptContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#set_operator_with_all_or_distinct.
    def enterSet_operator_with_all_or_distinct(self, ctx:PostgreSQLParser.Set_operator_with_all_or_distinctContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#set_operator_with_all_or_distinct.
    def exitSet_operator_with_all_or_distinct(self, ctx:PostgreSQLParser.Set_operator_with_all_or_distinctContext):
        pass
